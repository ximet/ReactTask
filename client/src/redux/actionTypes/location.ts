...
export enum ActionType {
  ...
  GET_LOCATION_HOURLY_AIR_QUALITY_PENDING = 'GET_LOCATION_HOURLY_AIR_QUALITY_PENDING',
  GET_LOCATION_HOURLY_AIR_QUALITY_SUCCESS = 'GET_LOCATION_HOURLY_AIR_QUALITY_SUCCESS',
  GET_LOCATION_HOURLY_AIR_QUALITY_FAIL = 'GET_LOCATION_HOURLY_WEATHER_FAIL',

  GET_LOCATION_DAILY_AIR_QUALITY_PENDING = 'GET_LOCATION_DAILY_AIR_QUALITY_PENDING',
  GET_LOCATION_DAILY_AIR_QUALITY_SUCCESS = 'GET_LOCATION_DAILY_AIR_QUALITY_SUCCESS',
  GET_LOCATION_DAILY_AIR_QUALITY_FAIL = 'GET_LOCATION_DAILY_WEATHER_FAIL',
