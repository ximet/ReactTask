...
export const getIsMessageSending = state => ({ ...state.feedback.isSending });

export const getFormData = createSelector(
  [getName, getPhone, getEmail, getMessage, getIsMessageSending],
  ({ value: name }, { value: phone }, { value: email }, { value: message }, isSending) => {
    return {
      name,
      phone,
      email,
