    ...
    <>
      <header>
        <ul className={styles.leftLinks}>
          <li><Link to='/' className={styles.leftLink}>Home</Link></li>
          <li><Link to='/about' className={styles.leftLink}>About us</Link></li>
        </ul>
        ...
        <ul className={styles.rightLinks}>
          <li><Link to='/feedback' className={styles.rightLink}>Feedback</Link></li>
        </ul>
      </header>
    </>
  );
