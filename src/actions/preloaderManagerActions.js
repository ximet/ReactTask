...
export const toggleCurrrentLocationPreloader = isLoading => ({
  type: CURRENT_LOCATION_IS_LOADING,
  isLoading: isLoading
});

export const toggleDailyForecastPreloader = isLoading => ({
  type: DAILY_FORECAST_IS_LOADING,
  isLoading: isLoading
});

export const toggleHourlyForecastPreloader = isLoading => ({
  type: HOURLY_FORECAST_IS_LOADING,
  isLoading: isLoading
});

export const toggleSearchPreloader = isLoading => ({
  type: SEARCH_IS_LOADING,
  isLoading: isLoading
});

export const toggleFavoriteForecastPreloader = (locationId, isLoading) => ({
