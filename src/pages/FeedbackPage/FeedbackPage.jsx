    ...
    <PageLayout>
      <form className={styles.feedback}>
        <div className={styles.feedback__formItem}>
          <label htmlFor="username" className={styles.bold}>Username</label>
          <input
          type="text"
          id="username"
        ...
        <div className={styles.feedback__formItem}>
          ...
          <div onChange={(e) => setUserFeedback({ ...userFeedback, gender: e.target.value })}>
            <label htmlFor="male" className={styles.bold}>Male</label>
            <input type="radio" name="gender" id="male" value="male" className={styles.feedback__text} />
            <label htmlFor="male" className={styles.bold}>Female</label>
            <input type="radio" name="gender" id="female" value="female" className={styles.feedback__text} />
          </div>
        </div>
        <div className={styles.feedback__formItem}>
          <label htmlFor="likes" className={styles.bold}>Do you like our page?</label>
          <input
          type="checkbox"
          id="likes"
          value="Like"
        ...
        <div className={styles.feedback__formItem}>
          <label htmlFor="age" className={styles.bold}>Give us rate!</label>
          <input
          type="number"
          min="0"
          max="10"
        ...
        <div className={styles.feedback__formItem}>
          <label htmlFor="country" className={styles.bold}>Country</label>
          <select
          id="country"
          name="country"
          className={styles.feedback__text}
